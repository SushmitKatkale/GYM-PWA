...
const StepOperatingHours: React.FC<StepOperatingHoursProps> = ({ formData, onChange }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 bg-yellow-600 text-white rounded-full flex items-center justify-center text-sm font-medium">3</div>
