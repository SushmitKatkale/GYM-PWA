          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`p-2 px-4 rounded-md transition-colors ${viewMode === 'calendar'
              ...
              <button
                ...
                className={`p-2 px-4 rounded-md transition-colors ${viewMode === 'list'
                  ? 'bg-white text-purple-600 shadow-sm'
                  : 'text-gray-500 hover:text-gray-700'
                  }`}
              >
              ...
              <button
                ...
                className={`p-2 px-4 rounded-md transition-colors ${viewMode === 'expanded'
                  ? 'bg-white text-purple-600 shadow-sm'
                  : 'text-gray-500 hover:text-gray-700'
                  }`}
              >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-3 py-2 rounded-lg transition-colors ${format(currentCalendarDate, 'yyyy-MM') >= format(new Date(), 'yyyy-MM')
                  ...
                  >
                    ...
                    {(isPastDate || (isCurrentDay && isCurrentMonth)) && (
                      <div className="flex items-center justify-center mt-1">
                        <div className={`w-3 h-3 rounded-full ${dayAttendance ? 'bg-blue-500' : 'bg-red-500'
                          }`}></div>
                      </div>
                    )}
                  </div>
