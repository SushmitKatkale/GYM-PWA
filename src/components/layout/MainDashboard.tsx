      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 overflow-y-auto pb-[5rem] md:pb-0 relative">
          ...
          <div className="md:hidden px-4 pt-3 sticky top-0 z-40">
            <div className="flex items-center justify-between">
              <div className='flex items-center space-x-3'>
                {/* Needs to show today date here */}
                <CalendarRange className="w-5 h-5 mb-1" />
                <h1 className='font-poppins'>{formattedDate}</h1>
              </div>
          ...
          <div className="md:p-6">{renderMainContent()}</div>
        </main>
      </div>
          ...
          <div className="absolute left-0 top-0 h-full w-80 bg-white shadow-xl transform transition-transform duration-300 ease-in-out">
            ...
            <div className="py-4">
              ...
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 transition-colors ${activeSettingsTab === 'profile' ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
              >
                <User className="w-5 h-5 text-gray-500 mr-3" />
                <span className="text-gray-700">Profile Information</span>
              ...
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 transition-colors ${activeSettingsTab === 'security' ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
              >
                <Shield className="w-5 h-5 text-gray-500 mr-3" />
                <span className="text-gray-700">Account Security</span>
              ...
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 transition-colors ${activeSettingsTab === 'privacy' ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
              >
                <Lock className="w-5 h-5 text-gray-500 mr-3" />
                <span className="text-gray-700">Privacy Settings</span>
              ...
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 transition-colors ${activeSettingsTab === 'notifications' ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
              >
                <Bell className="w-5 h-5 text-gray-500 mr-3" />
                <span className="text-gray-700">Notification Preferences</span>
              ...
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-50 transition-colors ${activeSettingsTab === 'preferences' ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                  }`}
              >
                <Settings className="w-5 h-5 text-gray-500 mr-3" />
                <span className="text-gray-700">App Preferences</span>
